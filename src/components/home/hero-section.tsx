...
export function HeroSection({ onOpenAuth }: HeroSectionProps) {
      ...
      try {
        ...
        if (result.success && result.data && result.data.length > 0) {
          ...
          setCarouselImages([{
            ...
            title_zh: '绿色技术平台',
            description_zh: '推动园区绿色转型，加速国家级经开区绿色产业发展',
            sort_order: 1,
            is_active: true
          }]);
        }
  ...
  // 检查当前轮播图是否有文字内容
  const hasTextContent = currentImage?.title_zh || currentImage?.description_zh;
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center text-white max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl md:text-2xl font-medium leading-relaxed mb-12">
              {currentImage?.description_zh || '推动园区绿色转型，加速国家级经开区绿色产业发展'}
            </p>
