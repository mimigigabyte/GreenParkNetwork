...
export default function MessageCenterPage() {
  ...
  const messageCategories = [
    { id: 'all', label: '全部类别', count: messages.length },
    { id: 'technical', label: '技术对接', count: 0, color: 'text-blue-600' },
    { id: 'audit', label: '发布审核', count: 0, color: 'text-orange-600' },
    { id: 'following', label: '我的关注', count: 0, color: 'text-green-600' },
    { id: 'security', label: '安全消息', count: 0, color: 'text-red-600' },
    { id: 'other', label: '其他', count: 0, color: 'text-gray-600' }
  ];
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-gray-500">请先登录查看消息</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <h1 className="text-2xl font-bold text-gray-900">全部消息</h1>
      </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <button
              ...
              className={`flex items-center space-x-1 text-sm font-medium border-b-2 pb-1 ${
          ...
          {selectedMessage ? (
            <>
              ...
              <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                ...
                <div className="text-sm text-gray-500">
                  发布于 {new Date(selectedMessage.created_at).toLocaleString('zh-CN')} | {selectedMessage.category || '技术对接'}
                </div>
              </div>
