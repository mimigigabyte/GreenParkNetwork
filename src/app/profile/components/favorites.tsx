...
const mockFavoriteTechnologies: AdminTechnology[] = [
  {
    ...
    company: { id: 'comp_A', name_zh: '光能无限公司' }
  },
  {
    id: 'tech_002',
    name_zh: '智能电网优化调度系统',
    ...
    category: { id: 'cat_02', name_zh: '节能环保' },
    subcategory: { id: 'sub_02', name_zh: '智能电网' },
    ...
    company: { id: 'comp_B', name_zh: '未来电网集团' }
  },
  {
    id: 'tech_003',
    name_zh: '工业余热回收利用技术',
    ...
    category: { id: 'cat_02', name_zh: '节能环保' },
    subcategory: { id: 'sub_03', name_zh: '能源回收' },
...
export default function Favorites() {
  const [favorites, setFavorites] = useState<AdminTechnology[]>([])
          ...
          <div key={tech.id} className="flex items-start space-x-4 p-4 border rounded-lg hover:shadow-md transition-shadow">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center text-xs text-gray-500 mt-2">
                ...
                <span>收藏于: {new Date(tech.created_at).toLocaleDateString()}</span>
              </div>
            </div>
