...
// project root is the parent of this folder
...
class TechDataImprover {
   ...
   */
  loadExistingData() {
    const dataPath = path.join(projectRoot, 'data', 'complete-69-wipo-wind-technologies.json');
  ...
  generateQualityReport() {
    ...
    const reportPath = path.join(projectRoot, 'data', 'quality-improvement-report.json');
