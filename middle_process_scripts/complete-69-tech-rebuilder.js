...
function loadExistingTechData() {
  ...
  const dataFiles = [
    path.join(dataRoot, 'batch-processed-29-techs.json'),
    path.join(dataRoot, 'batch-processed-11-techs.json'),
    path.join(dataRoot, 'batch-processed-3-techs.json'),
    path.join(dataRoot, 'first-tech-processed.json'),
    path.join(dataRoot, 'comprehensive-94-techs-processed.json')
  ];
